...
const CreatePermission =({setShowCreatePermission }) => {
...
async function handleSubmit (){
    ...
    const options = {
        method: 'POST',
        url: 'http://172.16.85.51:8000/api/makePermissions',
        headers: {
          'Content-Type': 'application/json',
          Accept: 'application/json',
          Authorization: `Bearer ${token}`,
        },
        data: {permissionName: newData.permissionName, description: newData.description}
      };
    ...
    // createPermission();
    setShowCreatePermission(false); // Close modal
  };
    ...
    return (
      ...
      >
        ...
        >
          <h3 className="text-lg font-semibold mb-4">Create Permission</h3>
